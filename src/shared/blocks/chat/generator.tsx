...
export function ChatGenerator() {
  ...
  return (
    ...
    >
      <div className="bg-background/6 dark:bg-background/6 absolute inset-0" />
      <div className="relative z-10 flex h-screen flex-col overflow-hidden">
        <header className="sticky top-0 z-10 flex w-full items-center gap-2 bg-transparent px-4 py-3">
