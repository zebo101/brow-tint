...
export function Footer({ footer }: { footer: FooterType }) {
  return (
    <footer
      id={footer.id}
      className={`relative overflow-x-hidden px-4 py-8 md:py-12 lg:py-16 ${footer.className || ''}`}
    >
      <div className="mx-auto w-full max-w-5xl">
        ...
        >
          {/* 胶带装饰 - 仅在中等及以上屏幕显示 */}
          <div className="absolute -top-4 -left-8 hidden h-[36px] w-[80px] scale-75 -rotate-12 text-[#4a8384] md:block">
            <TapeDecoration />
          </div>
          <div className="absolute -top-4 -right-8 hidden h-[36px] w-[80px] scale-75 rotate-90 text-[#4a8384] md:block">
            <TapeDecoration />
          </div>
          <div className="absolute -bottom-4 -left-8 hidden h-[36px] w-[80px] scale-75 rotate-180 text-[#4a8384] md:block">
            <TapeDecoration />
          </div>
          <div className="absolute -right-8 -bottom-4 hidden h-[36px] w-[80px] scale-75 -rotate-90 text-[#4a8384] md:block">
            <TapeDecoration />
          </div>
          ...
          <div className="relative z-10 flex flex-col justify-between gap-8 md:flex-row md:gap-12">
            {/* 品牌信息区域 */}
            <AnimatedContainer className="flex flex-col gap-4 md:max-w-sm">
        ...
        <AnimatedContainer delay={0.3} className="mt-4 px-2 md:px-8">
          <div className="flex flex-col items-start justify-between gap-4 text-sm sm:flex-row sm:items-center">
            <div className="flex w-full flex-col items-start gap-3 sm:w-auto">
              ...
              {footer.agreement ? (
                <div className="text-muted-foreground flex flex-wrap gap-3 text-xs sm:text-sm">
