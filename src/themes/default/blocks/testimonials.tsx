...
export function Testimonials({
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute top-0 right-0 z-0 hidden h-[480px] w-[480px] translate-x-1/5 -translate-y-1/4 opacity-60 md:block"
        style={{
          backgroundImage: "url('/imgs/bg/bg1.svg')",
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute bottom-0 left-0 z-0 hidden h-[380px] w-[380px] -translate-x-20 translate-y-18 opacity-45 md:block"
        style={{
          backgroundImage: "url('/imgs/bg/bg1.svg')",
          backgroundRepeat: 'no-repeat',
          backgroundSize: 'contain',
